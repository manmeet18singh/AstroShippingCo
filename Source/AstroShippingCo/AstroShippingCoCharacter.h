...
class AAstroShippingCoCharacter : public ACharacter
{
	...
	// Arrow Component for the Battery Camera 
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = Camera, meta = (AllowPrivateAccess = "true"))
		class UArrowComponent* CameraOrigin;

	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = Camera, meta = (AllowPrivateAccess = "true"))
		class UCameraComponent* CameraTransition;
...
public:
	...
	UFUNCTION(BlueprintCallable, BlueprintNativeEvent)
		void PlayBatteryTransition();

	// Cpp Function
	virtual void PlayBatteryTransition_Implementation();
