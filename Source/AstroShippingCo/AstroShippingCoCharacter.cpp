...
AAstroShippingCoCharacter::AAstroShippingCoCharacter()
{
	...
	CameraOrigin = CreateDefaultSubobject<UArrowComponent>(TEXT("CameraOrigin"));
	CameraOrigin->SetupAttachment(CameraBoom);
...
void AAstroShippingCoCharacter::PlayBatteryTransition_Implementation()
{
	GLog->Log("Write this in BP instead of cpp");
}
